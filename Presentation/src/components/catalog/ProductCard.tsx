...
export default function ProductCard({ product, isAdmin, onAddToCart, onUpdateStock }: ProductCardProps) {
  ...
  return (
    <article className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden flex flex-col hover:shadow-md transition-shadow">
      ...
      <div className="p-4 flex flex-col flex-1 gap-2">
        ...
        {isAdmin ? (
          <div className="flex items-center gap-2 mt-2 bg-gray-50 p-2 rounded-xl border border-gray-100">
            <button
